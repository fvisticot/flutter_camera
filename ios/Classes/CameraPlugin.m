...
didFinishProcessingPhoto:(AVCapturePhoto *)photo
    ...
    CGImageRef imageRef= [photo previewCGImageRepresentation];
    UIImage *previewImage = [UIImage imageWithCGImage: imageRef];
    bool success = [UIImageJPEGRepresentation(previewImage, 0.7) writeToFile:_path atomically:YES];
    ...
    UIImage *image = [UIImage imageWithCGImage:[UIImage imageWithData:data].CGImage
      ...
      success = [UIImageJPEGRepresentation(image, 0.4) writeToFile:_path atomically:YES];
      if (!success) {
...
- (void)captureOutput:(AVCapturePhotoOutput *)output
  ...
  bool success = [UIImageJPEGRepresentation(image, 0.4) writeToFile:_path atomically:YES];
  if (!success) {
    _result([FlutterError errorWithCode:@"IOError" message:@"Unable to write file" details:nil]);
    return;
  }
...
- (void)captureToFile:(NSString *)path result:(FlutterResult)result {
  ...
  //AVCapturePhotoSettings *settings = [AVCapturePhotoSettings photoSettingsWithFormat: @{AVVideoCodecKey : AVVideoCodecJPEG, AVVideoQualityKey: @0.5, AVVideoWidthKey: @1024, AVVideoHeightKey: @768}];
